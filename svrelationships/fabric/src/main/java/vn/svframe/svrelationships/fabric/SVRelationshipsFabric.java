...
import vn.svframe.svrelationships.fabric.command.LifeEventCommands;
...
public final class SVRelationshipsFabric implements ModInitializer {
    ...
    @Override public void onInitialize() {
        ...
        var runtime = new RuntimeCoordinator(config, gameplay, rules, rewardPolicies, ceremonyDefinitions, guiDefinitions, messages, households, providers, relationshipRepository, daycareRepository, lineageRepository, rewardClaims);
