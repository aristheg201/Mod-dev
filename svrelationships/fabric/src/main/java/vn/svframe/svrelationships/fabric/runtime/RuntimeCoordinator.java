...
public final class RuntimeCoordinator implements AutoCloseable {
    private final ConfigService config; private final GameplayDefinitionService gameplay; private final RelationshipRuleService rules; private final RewardPolicyService rewardPolicies; private final CeremonyDefinitionService ceremonyDefinitions;
    ...
    private final RelationshipService relationships; private final LifeInteractionService interactions; private final PartnershipService partnerships; private final RelationshipRewardService rewards; private final CeremonyService ceremonies;
