...
final class FactionActionTest {
    ...
    void recruitStrategyAddsUnassignedNpcAndUpdatesActorFacts() {
        ...
        assertEquals(1, actions.pulse(6000L));
    ...
    @Test
    void patrolAddsSecurityButCooldownPreventsRepeatedExecution() {
