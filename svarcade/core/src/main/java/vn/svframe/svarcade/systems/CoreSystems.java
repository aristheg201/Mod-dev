...
import vn.svframe.svarcade.systems.interaction.InteractionSystem;
import vn.svframe.svarcade.systems.loadout.LoadoutSystem;
...
public final class CoreSystems {
    ...
    public static SystemCatalog.Builder builder(Registry<ActionHandlerFactory> actionHandlers,
        ...
        return SystemCatalog.builder()
                ...
                .add(LoadoutSystem.ID, new LoadoutSystem.Plan())
