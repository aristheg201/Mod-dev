...
/**
 * Installs the 0.1.1 player-facing modules on top of the exact bundled SVArcade handbook.
...
object V011ContentPatch {
    private const val MARKER_PAGE = "svarcade_v011"
    ...
    fun apply(content: HubContent): HubContent? {
        ...
        val launchPad = listOf(
            ...
            component("v011_intro", "notice", "text" to "Gacha CS:GO, Skin Showcase và Linh Thú đã được gom vào cùng SVArcade. Tất cả giao dịch vẫn do server xác thực."),
        ...
        val marker = HubPage(
            ...
            route = "system/v011",
            category = "system",
            title = LocalizedText.of("SVArcade 0.1.1"),
            theme = "sv_arcade",
