...
import io.github.aristheg201.svarcade.native.game.NativeBotPlanner
...
import io.github.aristheg201.svarcade.native.game.TftBotPlanner
    ...
    fun start() {
        ...
        synchronized(this) {
            ...
            executor = ThreadPoolExecutor(
                ...
                { task -> Thread(task, "SVArcade-Bot-${threadCounter.incrementAndGet()}").apply { isDaemon = true; priority = Thread.NORM_PRIORITY - 1 } },
            ...
            try {
                pool.execute {
                    ...
                    plan.onSuccess { result ->
                        ...
                        .onFailure { error -> SVArcade.LOGGER.warn("Native bot planner failed for {} / {}", view.gameId, sessionId, error) }
                }
