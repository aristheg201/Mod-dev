...
data class EnvironmentManifest(
    ...
    companion object {
        ...
        /**
         * Public server advertisement: SVArcade version/capabilities only. The server's
        ...
        private fun build(modFilter: Set<String>?, extraCapabilities: Set<String>): EnvironmentManifest {
            ...
            val mods = loader.allMods.asSequence()
                ...
                .sortedBy { it.id }
                .toList()
            return EnvironmentManifest(hubVersion(), mods, extraCapabilities + SVArcadeApi.advertisedCapabilities())
        }
