...
import io.github.aristheg201.svarcade.native.game.tft.TftUnitDefinition
import io.github.aristheg201.svarcade.native.game.tft.TftAcquisition
import io.github.aristheg201.svarcade.native.game.tft.TftPermanentEvolution
import io.github.aristheg201.svarcade.native.game.tft.poolSourceUnitId
import io.github.aristheg201.svarcade.native.game.tft.reservedCopies
import io.github.aristheg201.svarcade.native.game.tft.TftCombatEngine
import io.github.aristheg201.svarcade.native.game.tft.TftCombatSnapshot
import io.github.aristheg201.svarcade.native.game.tft.TftCombatUnit
import io.github.aristheg201.svarcade.native.game.tft.TftCapability
import io.github.aristheg201.svarcade.native.game.tft.TftDefinitionValidator
import io.github.aristheg201.svarcade.native.game.tft.TftOwnedUnit
import io.github.aristheg201.svarcade.native.game.tft.TftPveRoundDefinition
...
import io.github.aristheg201.svarcade.native.game.tft.TftProgression
import io.github.aristheg201.svarcade.native.game.tft.TftProgressionDefinition
import io.github.aristheg201.svarcade.native.game.tft.TftPlayerModifier
import io.github.aristheg201.svarcade.native.game.tft.TftPlayerModifierSet
...
class TftSession(
    ...
    private class SharedPool(private val set:TftSetDefinition,private val rng:Random){
        ...
        private fun reserveCost(cost:Int,eligible:(io.github.aristheg201.svarcade.native.game.tft.TftUnitDefinition)->Boolean):String?{val candidates=counts.entries.filter{it.value>0&&defs[it.key]?.cost==cost&&eligible(defs.getValue(it.key))};val chosen=candidates.weightedByCount()?:return null;counts[chosen]=counts.getValue(chosen)-1;return chosen}
