package io.github.aristheg201.svarcade.client.gui

import io.github.aristheg201.svarcade.client.ClientHubState
...
import io.github.aristheg201.svarcade.network.HubActionC2S
...
class HubScreen(
...
) : SVArcadeScreen(Component.literal("SVArcade")) {
    ...
    override fun init() {
        ...
        search = EditBox(font, searchX + 7, 10, searchWidth - 14, 22, Component.translatable("gui.svarcade.search"))
        search.setHint(Component.translatable("gui.svarcade.search_hint"))
    ...
    private fun renderChrome(gui: GuiGraphics, theme: HubTheme, mouseX: Int, mouseY: Int) {
        ...
        if (ClientHubState.canEdit && overrideContent == null && width >= 560) {
            ...
            gui.drawCenteredString(font, Component.translatable("gui.svarcade.editor"), x + 36, 17, p.text)
            hitTargets += HubHitTarget(x, 8, x + 72, 34) { io.github.aristheg201.svarcade.client.SVArcadeClient.requestEditor() }
        }
    }
    ...
    private fun renderSidebar(gui: GuiGraphics, theme: HubTheme, sidebarWidth: Int, mouseX: Int, mouseY: Int) {
        ...
        gui.drawString(font, Component.translatable("gui.svarcade.sidebar.contents"), 16, CHROME_HEIGHT + 13, p.mutedText, true)
    ...
    private fun renderNotFound(gui: GuiGraphics, theme: HubTheme, missing: String) {
        ...
        gui.drawCenteredString(font, Component.translatable("gui.svarcade.not_found"), width / 2, top + 24, theme.palette.danger)
