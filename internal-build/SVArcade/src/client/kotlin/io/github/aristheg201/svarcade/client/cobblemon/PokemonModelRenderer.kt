...
import io.github.aristheg201.svarcade.native.game.tft.PokemonAnimationResolver
 ...
 * SVArcade's camera, transform and private render target.
 */
...
object PokemonModelRenderer {
    ...
    private val logger = org.slf4j.LoggerFactory.getLogger("SVArcade/PokemonModels")
