...
import io.github.aristheg201.svarcade.search.SearchHit
import io.github.aristheg201.svarcade.search.SearchIndex
...
object ClientHubState {
    ...
    fun search(query: String, limit: Int = 30): List<SearchHit> {
        ...
        val extensions = SVArcadeClientApi.search(query, content, limit)
