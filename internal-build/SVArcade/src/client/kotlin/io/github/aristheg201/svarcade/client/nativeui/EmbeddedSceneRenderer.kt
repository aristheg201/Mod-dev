...
/** Worldless 3D viewport. Geometry, model transforms, camera and depth belong to SVArcade. */
object EmbeddedSceneRenderer {
    ...
    private fun compileMeshes(scene: SVArcadeScene, theme: MinecraftArenaDefinition): List<Mesh> {
