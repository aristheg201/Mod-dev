...
import io.github.aristheg201.svarcade.native.network.NativeCloseS2C
import io.github.aristheg201.svarcade.native.network.NativeOpenS2C
import io.github.aristheg201.svarcade.native.network.NativeStateS2C
import io.github.aristheg201.svarcade.native.network.NativeDeltaS2C
...
import io.github.aristheg201.svarcade.native.network.NativeTftPreviewS2C
import io.github.aristheg201.svarcade.native.network.NativeTftPreviewResultC2S
...
import io.github.aristheg201.svarcade.native.NativeArcadeLifecyclePolicy
import io.github.aristheg201.svarcade.native.game.tft.PokemonAnimationSemantic
        ...
        ClientPlayNetworking.registerGlobalReceiver(NativeTftPreviewS2C.TYPE) { payload, context ->
            context.client().execute {
                ...
                val view=PokemonView(
                    key="svarcade-preview:${payload.requestId}",
                    route="",
