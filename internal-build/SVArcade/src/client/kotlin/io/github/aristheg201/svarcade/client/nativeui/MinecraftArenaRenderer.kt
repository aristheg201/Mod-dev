...
import io.github.aristheg201.svarcade.ui.SceneNode
...
import io.github.aristheg201.svarcade.ui.SceneInteractionSurface
import io.github.aristheg201.svarcade.ui.SVArcadeScene
...
data class MinecraftArenaDefinition(
    ...
    init {
        if(texturedBattlefield) {
            ...
            geometry.forEach { node ->
                val bounds=io.github.aristheg201.svarcade.ui.SceneBounds.enclosing(node.corners())
    ...
    fun framingAnchors():List<ArenaPoint> = benchAnchors + tacticianSpawn
...
object MinecraftArenaRegistry {
    ...
    private val logger=org.slf4j.LoggerFactory.getLogger("SVArcade/Arenas")
    ...
    fun reload(resources: ResourceManager): Boolean {
        ...
        resources.listResources("arenas") { it.namespace=="svarcade" && it.path.endsWith(".json") }.forEach { (location,resource) ->
...
object MinecraftArenaRenderer {
    data class CompiledArenaScene(val scene:SVArcadeScene)
    ...
    fun compiledScene(layout:PokemonSceneLayout,theme:MinecraftArenaDefinition):CompiledArenaScene{
        ...
        return compiledScenes.computeIfAbsent(key){
            ...
            CompiledArenaScene(SVArcadeScene("arena:${theme.id}:${theme.definitionRevision}",resourceRevision,listOfNotNull(floor)+terrain+structures+tiles+benches+props,listOf(interaction)))
        }
    }
    ...
    fun interactionRect(layout:PokemonSceneLayout,region:ArenaInteractionRegion):io.github.aristheg201.svarcade.ui.UiRect?{
        ...
        return io.github.aristheg201.svarcade.ui.UiRect(left,top,(right-left).coerceAtLeast(1),(bottom-top).coerceAtLeast(1))
    }
