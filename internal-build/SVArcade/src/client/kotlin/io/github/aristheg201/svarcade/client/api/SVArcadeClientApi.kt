package io.github.aristheg201.svarcade.client.api
...
object SVArcadeClientApi {
    ...
    fun registerGridProvider(id: String, provider: DynamicGridProvider) {
        require(idPattern.matches(id)) { "Invalid SVArcade grid provider '$id'" }
    ...
    fun registerSearchProvider(id: String, provider: DynamicSearchProvider) {
        require(idPattern.matches(id)) { "Invalid SVArcade search provider '$id'" }
