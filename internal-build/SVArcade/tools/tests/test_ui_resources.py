...
from svarcade_png import SIGNATURE, chunk, decode, encode, paeth
...
class SmokeContractTests(unittest.TestCase):
    ...
    def test_log_regressions(self):
        for text in ("Failed to load texture: svarcade:textures/a.png", "unknown PNG chunk type", "bad PNG CRC in IDAT", "invalid PNG zlib stream", "Failed to decode svarcade:textures/wiki.png", "Minecraft has crashed!", "ReportedException", "Rendering screen", "OpenGL error", "[SVArcade Visual Smoke] timed out"):
