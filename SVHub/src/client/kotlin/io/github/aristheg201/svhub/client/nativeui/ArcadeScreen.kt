    ...
    fun render(gui: GuiGraphics, font: Font, width: Int, height: Int, state: JsonObject, mx: Int, my: Int, hooks: Hooks) {
        ...
        fun hero(r:UiRect,home:Boolean) {
            gui.withArcadeScissor(r) {
                ...
                val rendered=io.github.aristheg201.svhub.client.cobblemon.PokemonModelRenderer.render(gui,view,r.x+r.width*72/100,r.y+r.height*25/100,(r.height*1.15f).toInt(),25f,1.7f,12f)
