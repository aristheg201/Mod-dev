    ...
    fun create(): HubContent {
        ...
        val commands = HubPage(
            ...
            components = listOf(
                ...
                commandRun("cmd_dep_beast", "/beco deposit beastcoin", "Nạp BeastCoin item vào số dư nếu đang cầm đúng vật phẩm."),
                commandRun("cmd_dep_hunter", "/beco deposit huntercoin", "Nạp HunterCoin item vào số dư nếu đang cầm đúng vật phẩm."),
                commandTemplate("cmd_with_beast", "/beco withdraw <số lượng> beastcoin", "Rút BeastCoin từ số dư."),
                commandTemplate("cmd_with_hunter", "/beco withdraw <số lượng> huntercoin", "Rút HunterCoin từ số dư."),
        ...
        val pokemonShop = HubPage(
            ...
            tags = listOf("shop pokemon", "gts", "gacha", "keyshop", "wondertrade", "sts", "huntercoin", "beastcoin"),
            theme = "clean_dark",
            components = listOf(
                ...
                component("shop_key_text", "text", "text" to "Key Shop bán key bằng HunterCoin hoặc BeastCoin. Event key không bán quanh năm."),
                table("shop_key_prices", listOf(
                    listOf("Loại key", "Gói", "Giá"),
                    listOf("Starter", "10 key", "2 HunterCoin"),
                    listOf("Starter", "5 key", "25 BeastCoin"),
                    listOf("Legendary", "10 key", "4 HunterCoin"),
                    listOf("Legendary", "1 key", "50 BeastCoin"),
                    listOf("Legendary Shiny", "10 key", "8 HunterCoin"),
                    listOf("Skin", "10 key", "12 HunterCoin"),
                    listOf("Ultra & Paradox", "10 key", "16 HunterCoin")
                )),
                ...
                table("shop_currency", listOf(
                    ...
                    listOf("BeastCoin", "Tiền gameplay đặc biệt; dùng ở một số shop/key và skin."),
                    listOf("HunterCoin", "Tiền premium; không đổi trực tiếp từ CobbleDollars.")
                )),
                component("shop_exchange", "notice", "text" to "Tỷ giá server hiện có: 300,000 CobbleDollars → 1 BeastCoin, một chiều."),
